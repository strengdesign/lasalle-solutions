...
<% if (CompatibilityHelper.IsVersion7OrNewer)
   {
    %>
<link rel="stylesheet" href="<%= MainPath %>css/stylev7.css?version=<%= Umbraco.Forms.Core.Configuration.Version %>" type="text/css" media="screen" />
                    ...
                    <asp:Repeater ID="rptFieldsets" runat="server" OnItemDataBound="RenderFieldset">
                        <ItemTemplate>
                            <div rel="<%# ((Umbraco.Forms.Core.FieldSet)Container.DataItem).Id %>" id="<%# ((Umbraco.Forms.Core.FieldSet)Container.DataItem).Id %>"
                                ...
                                <button class="addfield btn" onclick="javascript:ShowAddFieldDialog('<%# ((Umbraco.Forms.Core.FieldSet)Container.DataItem).Id %>'); return false;">
                                    <% if (CompatibilityHelper.IsVersion7OrNewer)
                                       { %>
                                     <i title="Add Field" class="icon icon-add"></i>
                                    <% }
                                       else
                                       { %>
...
<div id="modals" style="display: none;" >
    ...
    <div id="FieldsetModal" style="display: none;">
        <h1>
            Add Fieldset</h1>
    ...
    <div id="FieldModal" style="display: none;" >
        ...
        <fieldset>
            ...
            <p style="clear: both;">
                <input class="submit btn btn-primary" type="submit" value="Add Field" id="addUpdateField" />
                 <% if(!CompatibilityHelper.IsVersion7OrNewer){ %>or<% } %> <a href="#" class="CancelModal" id="cancelfieldaction">Cancel</a>
            </p>
        </fieldset>
        </form>
    </div>
    <div id="PreValueModal" style="display: none;">
