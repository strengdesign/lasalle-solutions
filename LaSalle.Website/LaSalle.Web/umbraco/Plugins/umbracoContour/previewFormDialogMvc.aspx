...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        body, html {margin: 0px 0px 20px 0px; padding: 0px 0px 0px 0px; font-size: 12px; background:#fff; font-family: "Lucida Grande", Arial, sans-serif;}
...
<body>
    ...
    <umbraco:Macro runat="server" Alias="umbracoContourRazorRenderForm" FormGuid="[@guid]" />
</body>
</html>