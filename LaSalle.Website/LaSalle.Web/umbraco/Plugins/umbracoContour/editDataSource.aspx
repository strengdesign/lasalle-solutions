...
<asp:Content ID="Content" ContentPlaceHolderID="body" runat="server">
     ...
     <script type="text/javascript" src="scripts/jquery.simplemodal-1.2.3.js"></script>
      ...
      <umb:TabView ID="TabView1" runat="server" Width="552px" Height="692px" Text="Data Source" />
      ...
      <umb:Pane ID="paneCreateForm" runat="server" Visible="false">
        ...
        <asp:Button ID="btnCreateFormFrom" runat="server" Text="Create form" OnClientClick="ShowCreateFormFromDataSourceDialog();return false;" CssClass="btn btn-primary" />
      ...
      <umb:Pane ID="paneForms" runat="server" Visible="false">
            ...
            <% if (CompatibilityHelper.IsVersion7OrNewer)
               {
            %>
                 <h4 class="propertypaneTitel">Create new form</h4>
            <% }
               else
               {
             %>      
           ...
           <% if (CompatibilityHelper.IsVersion7OrNewer)
               {
            %>
                <h4 class="propertypaneTitel">Forms using this workflow</h4>
            <% }
               else
               {
             %>      
